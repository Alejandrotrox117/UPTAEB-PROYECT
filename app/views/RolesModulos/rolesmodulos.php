...
<main class="flex-1 p-6">
    <div class="flex justify-between items-center">
        <h2 class="text-xl font-semibold">Administración de Roles y Módulos</h2>
    ...
    <div class="min-h-screen mt-6">
        ...
        <p class="text-green-500 text-lg">Gestión de accesos de roles a módulos del sistema</p>
        ...
        <div class="bg-white p-8 mt-6 rounded-2xl shadow-lg">
            ...
            <div class="overflow-x-auto">
                <table id="TablaRolesModulos" class="w-full text-left border-collapse">
                    <thead>
...
<div id="modalRegistrarRolModulo"
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-2xl max-h-[95vh]">
        <div class="px-6 py-4 border-b flex justify-between items-center">
            <h3 id="tituloModalRegistrar" class="text-2xl font-bold text-gray-800">Nueva Asignación Rol-Módulo</h3>
        ...
        <form id="formRegistrarRolModulo" class="px-8 py-6 max-h-[70vh] overflow-y-auto">
            <!-- Rol -->
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select id="moduloSelect" name="idmodulo" class="w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-400" required>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit" id="btnGuardarRolModulo" form="formRegistrarRolModulo" class="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition text-base font-medium">
...
<div id="modalActualizarRolModulo"
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-2xl max-h-[95vh]">
        <div class="px-6 py-4 border-b flex justify-between items-center">
            <h3 id="tituloModalActualizar" class="text-2xl font-bold text-gray-800">Actualizar Asignación Rol-Módulo</h3>
        ...
        <form id="formActualizarRolModulo" class="px-8 py-6 max-h-[70vh] overflow-y-auto">
            ...
            <div class="mb-4">
                ...
                <select id="moduloSelectActualizar" name="idmodulo" class="w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-400" required>
                    <option value="">Seleccione un módulo</option>
                </select>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit" id="btnActualizarRolModulo" form="formActualizarRolModulo" class="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition text-base font-medium">
...
<div id="modalVerRolModulo" class="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-[2px] opacity-0 pointer-events-none transition-opacity duration-300 z-50">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-2xl max-h-[95vh]">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh]">
            ...
            <div class="p-6 overflow-y-auto max-h-[70vh]">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Título del Módulo</label>
                            <p id="verModuloTitulo" class="text-gray-900 dark:text-white font-medium">-</p>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Descripción del Módulo</label>
