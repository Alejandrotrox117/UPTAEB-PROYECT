...
<div id="modalRegistrarPago"
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-full sm:w-10/11 max-w-4xl max-h-[95vh]">
        ...
        <form id="formRegistrarPago" class="px-4 md:px-8 py-6 max-h-[calc(70vh-120px)] sm:max-h-[60vh] overflow-y-auto">
            ...
            <!-- Container para compras -->
            <div id="containerCompras" class="mb-4 hidden">
                <label for="pagoCompra" class="block text-sm font-medium text-gray-700 mb-1">
                    Seleccionar Compra <span class="text-red-500">*</span>
                </label>
                <select id="pagoCompra" name="pagoCompra" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    <option value="">Seleccionar compra...</option>
                </select>
                <div id="error-pagoCompra" class="text-red-500 text-sm mt-1 hidden"></div>
            </div>

            <!-- Container para ventas -->
            <div id="containerVentas" class="mb-4 hidden">
                <label for="pagoVenta" class="block text-sm font-medium text-gray-700 mb-1">
                    Seleccionar Venta <span class="text-red-500">*</span>
                </label>
                <select id="pagoVenta" name="pagoVenta" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    <option value="">Seleccionar venta...</option>
                </select>
                <div id="error-pagoVenta" class="text-red-500 text-sm mt-1 hidden"></div>
            </div>

            <!-- Container para sueldos -->
            <div id="containerSueldos" class="mb-4 hidden">
                <label for="pagoSueldo" class="block text-sm font-medium text-gray-700 mb-1">
                    Seleccionar Sueldo <span class="text-red-500">*</span>
                </label>
                <select id="pagoSueldo" name="pagoSueldo" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    <option value="">Seleccionar sueldo...</option>
                </select>
                <div id="error-pagoSueldo" class="text-red-500 text-sm mt-1 hidden"></div>
            </div>

            <!-- Container para descripción (otros pagos) -->
            <div id="containerDescripcion" class="mb-4 hidden">
                <label for="pagoDescripcion" class="block text-sm font-medium text-gray-700 mb-1">
                    Descripción del Pago <span class="text-red-500">*</span>
                </label>
                <textarea id="pagoDescripcion" name="pagoDescripcion" rows="3" 
            ...
            <div id="containerDestinatario" class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200 hidden">
                <h5 class="font-medium text-blue-800 mb-2">
                    <i class="fas fa-info-circle mr-1"></i> Información del Destinatario
                </h5>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                    <div>
                        <span class="text-blue-600 font-medium">Nombre:</span>
                        <span id="destinatarioNombre" class="text-gray-800 ml-1">-</span>
                    </div>
                    <div>
                        <span class="text-blue-600 font-medium">Identificación:</span>
                        <span id="destinatarioIdentificacion" class="text-gray-800 ml-1">-</span>
                    </div>
                    <div>
                        <span class="text-blue-600 font-medium">Total:</span>
                        <span id="destinatarioTotal" class="text-gray-800 ml-1 font-semibold">-</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <!-- Monto -->
                <div>
                    <label for="pagoMonto" class="block text-sm font-medium text-gray-700 mb-1">
                        Monto <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">Bs. </span>
                        <input type="text" id="pagoMonto" name="pagoMonto" 
                ...
                <!-- Método de Pago -->
                <div>
                    <label for="pagoMetodoPago" class="block text-sm font-medium text-gray-700 mb-1">
                        Método de Pago <span class="text-red-500">*</span>
                    </label>
                    <select id="pagoMetodoPago" name="pagoMetodoPago" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <!-- Referencia -->
                <div>
                    <label for="pagoReferencia" class="block text-sm font-medium text-gray-700 mb-1">
                        Referencia
                    </label>
                    <input type="text" id="pagoReferencia" name="pagoReferencia" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <!-- Fecha -->
                <div>
                    <label for="pagoFecha" class="block text-sm font-medium text-gray-700 mb-1">
                        Fecha de Pago <span class="text-red-500">*</span>
                    </label>
                    <input type="date" id="pagoFecha" name="pagoFecha" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div class="md:col-span-2">
                    <label for="pagoObservaciones" class="block text-sm font-medium text-gray-700 mb-1">
                        Observaciones
                    </label>
                    <textarea id="pagoObservaciones" name="pagoObservaciones" rows="3" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
        ...
        <div class="bg-gray-50 px-4 md:px-6 py-3 md:py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
            <button type="button" id="btnCancelarModalRegistrar" class="w-full sm:w-auto px-4 py-2 md:px-6 md:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-sm md:text-base font-medium">
                <i class="fas fa-times mr-1 md:mr-2"></i> Cancelar
            </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span id="verPagoId" class="font-medium text-gray-800">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Tipo:</span>
                                    <span id="verPagoTipo" class="font-medium text-gray-800">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Destinatario:</span>
                                    <span id="verPagoDestinatario" class="font-medium text-gray-800">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Estatus:</span>
                                    <span id="verPagoEstatus" class="font-medium">-</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 p-4 rounded-lg">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span id="verPagoMonto" class="font-bold text-green-600 text-lg">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Método:</span>
                                    <span id="verPagoMetodo" class="font-medium text-gray-800">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Referencia:</span>
                                    <span id="verPagoReferencia" class="font-medium text-gray-800">-</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span id="verPagoFecha" class="font-medium text-gray-800">-</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Fecha de Creación:</span>
                                    <span id="verPagoFechaCreacion" class="font-medium text-gray-800">-</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-purple-50 p-4 rounded-lg">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Persona Asignada:</span>
                                    <span id="verPagoPersona" class="font-medium text-gray-800">-</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-yellow-50 p-4 rounded-lg">
                            ...
                            <p id="verPagoObservaciones" class="text-gray-700 text-sm leading-relaxed">-</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-4 md:px-6 py-3 md:py-4 border-t border-gray-200 flex justify-end">
                <button id="btnCerrarModalVerFooter" type="button" class="px-4 py-2 md:px-6 md:py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition text-sm md:text-base font-medium">
