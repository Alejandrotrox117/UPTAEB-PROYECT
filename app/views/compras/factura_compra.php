    ...
    <?php else:
      ...
      <div id="facturaContent" class="p-6 md:p-8 print:p-6">
        ...
        <div class="grid grid-cols-3 gap-4 mb-6 print:mb-6 print:pb-4">
          ...
          <div class="flex justify-start items-start print:border-0 print:p-3">
            <img src="<?= base_url('app/assets/img/LOGO.png'); ?>" alt="Logo"
              class="h-16 md:h-20 object-contain print:h-16">
          </div>

          <!-- INFO EMPRESA (Columna 2) -->
          <div class="text-center print:border-0 print:p-3">
            <h2 class="text-lg font-bold text-gray-800 mb-2 print:text-base print:mb-2 print:text-black print:font-bold">
              RECUPERADORA LA PRADERA DE PAVIA</h2>
            <div class="text-xs text-gray-600 space-y-1 print:text-sm print:text-black print:space-y-1">
              ...
              <p class="text-[10px] print:text-xs">Estado Lara, Municipio Iribarren, KM 12 Carretera Vieja Hacia Carora
                Pavía Barquisimeto.</p>
            </div>
          </div>

          <!-- INFO DE FACTURA (Columna 3) -->
          <div class="text-center print:border-0 print:p-3">
            <h3 class="text-lg font-bold text-blue-800 mb-2 print:text-base print:text-black print:mb-2 print:font-bold">
              NOTA DE RECEPCION</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 print:grid-cols-2 print:gap-6 print:mb-6">
          ...
          <div class="bg-gray-50 p-6 rounded-lg print:bg-gray-50 print:p-4 print:rounded-none">
            <h4
              class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-300 pb-2 print:text-lg print:mb-3 print:text-black print:border-gray-400 print:pb-2 print:font-semibold">
              PROVEEDOR
            </h4>
            <div class="space-y-3 text-sm print:space-y-2 print:text-sm">
              <div class="print:block">
                <span class="font-semibold text-gray-700 print:text-black print:font-semibold">Nombre/Razón Social:
                </span>
                <span
                  class="text-gray-900 print:text-black"><?= htmlspecialchars($proveedor ?: 'No especificado') ?></span>
              </div>
              <div class="print:block">
                <span class="font-semibold text-gray-700 print:text-black print:font-semibold">Identificación: </span>
                <span
                  class="text-gray-900 print:text-black"><?= htmlspecialchars($compra['personaId'] ?? 'No especificado') ?></span>
              </div>
              <div class="print:block">
                <span class="font-semibold text-gray-700 print:text-black print:font-semibold">Teléfono: </span>
                <span
                  class="text-gray-900 print:text-black"><?= htmlspecialchars($compra['telefono'] ?? 'No especificado') ?></span>
              </div>
              ...
              <?php if (!empty($data['tasaDelDia'])): ?>
                <div class="print:block mt-2 pt-2 border-t border-gray-300">
                  ...
                  <?php foreach ($data['tasaDelDia'] as $tasa): ?>
                    <span class="font-medium ml-2"><?= htmlspecialchars($tasa['codigo_moneda']) ?>:</span> Bs.
                    <?= formatearDecimalesInteligente($tasa['tasa_a_bs']) ?>
                  <?php endforeach; ?>
                </div>
              <?php endif; ?>
            </div>
            ...
            <table class="w-full table-auto border-collapse print:text-sm">
              <thead>
                <tr class="bg-gray-200 text-gray-800 text-sm print:bg-gray-200 print:text-black print:text-sm">
                  <th
                    class="px-6 py-4 text-center font-bold border border-gray-400 print:px-4 print:py-3 print:border print:border-gray-400 print:font-bold">
                    #</th>
                  <th
                    class="px-6 py-4 text-left font-bold border border-gray-400 print:px-4 print:py-3 print:border print:border-gray-400 print:font-bold">
                    Descripción</th>
                  <th
                    class="px-6 py-4 text-left font-bold border border-gray-400 print:px-4 print:py-3 print:border print:border-gray-400 print:font-bold">
                    Detalles</th>
              ...
              <tbody>
                ...
                if (!empty($data['arrCompra']['detalles']) && count($data['arrCompra']['detalles']) > 0) {
                  foreach ($data['arrCompra']['detalles'] as $producto) {
                    if (!in_array($producto['productoId'], $productos_mostrados)) {
                      ...
                      <tr class="hover:bg-gray-50 transition-colors print:hover:bg-transparent bg-white print:bg-white">
                        <td
                          class="px-6 py-3 text-center text-sm font-medium text-gray-900 border border-gray-400 print:px-4 print:py-2 print:text-sm print:text-black print:border print:border-gray-400">
                          <?= $contador ?></td>
                        ...
                        <td
                          class="px-6 py-3 text-sm text-gray-600 border border-gray-400 print:px-4 print:py-2 print:text-sm print:text-gray-600 print:border print:border-gray-400">
                        ...
                        <td
                          class="px-6 py-3 text-center text-sm font-bold text-gray-900 border border-gray-400 print:px-4 print:py-2 print:text-sm print:text-black print:border print:border-gray-400 print:font-bold">
                  ...
                  <tr>
                    <td colspan="6"
                      class="px-6 py-8 text-center text-gray-500 border border-gray-400 print:px-4 print:py-6 print:text-black print:border print:border-gray-400">
              ...
              <tfoot>
                <tr class="bg-white print:bg-white">
                  <th colspan="5"
                    class="px-6 py-4 text-right text-lg font-bold text-gray-800 border border-gray-400 print:px-4 print:py-3 print:text-base print:text-black print:border print:border-gray-400 print:font-bold">
                    TOTAL GENERAL:
                  </th>
                  <td
                    class="px-6 py-4 text-center text-xl font-bold text-green-700 border border-gray-400 print:px-4 print:py-3 print:text-base print:text-green-700 print:border print:border-gray-400 print:font-bold">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-30 print:grid-cols-3 print:gap-6 print:mt-40">
          <div class="text-center print:text-center">
            ...
            <div class="border-t border-gray-400 pt-2 print:border-t print:border-gray-400 print:pt-2">
              <p class="text-sm font-semibold text-gray-700 print:text-sm print:text-black print:font-semibold">ENTREGADO
                POR</p>
          ...
          <div class="text-center print:text-center">
            <div class="border-t border-gray-400 pt-2 print:border-t print:border-gray-400 print:pt-2">
              <p class="text-sm font-semibold text-gray-700 print:text-sm print:text-black print:font-semibold">RECIBIDO
                POR</p>
              <p class="text-xs text-gray-500 mt-1 print:text-xs print:text-gray-600 print:mt-1">Nombre y Firma del
                Cliente</p>
            </div>
          </div>
          <div class="text-center print:text-center">
            <div class="border-t border-gray-400 pt-2 print:border-t print:border-gray-400 print:pt-2">
              <p class="text-sm font-semibold text-gray-700 print:text-sm print:text-black print:font-semibold">FECHA DE
                ENTREGA</p>
        ...
        <!-- PIE DE PÁGINA -->
        <div
          class="mt-8 pt-4 border-t border-gray-300 text-center text-xs text-gray-500 print:mt-6 print:pt-3 print:border-t print:border-gray-300 print:text-center print:text-xs print:text-gray-600">
      ...
      <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 print:hidden">
        <div class="flexre flex-col sm:flex-row gap-3 justify-center">
          <button id="printBtn"
            class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center justify-center">
            <i class="fas fa-print mr-2"></i>
            Imprimir Nota de Recepcion
          </button>
          <a href="<?= base_url(); ?>compras"
            class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center justify-center">
