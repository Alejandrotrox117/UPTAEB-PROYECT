...
<div id="modalEditarCompra" class="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-[2px] opacity-0 pointer-events-none transition-opacity duration-300 z-50">
  <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-4xl">
    <!-- Encabezado del Modal -->
    <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
      <h3 class="text-2xl font-bold text-gray-800">
    ...
    <!-- Contenido del Modal (Formulario) -->
    <form id="formEditarCompraModal" class="px-8 py-6 max-h-[70vh] overflow-y-auto">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                <div>
                    <label for="fechaActualizar" class="form-label">Fecha Compra <span class="text-red-500">*</span></label>
                    <input type="date" id="fechaActualizar" name="fechaActualizar" class="w-1/3 border rounded-md px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        ...
        <div>
            ...
            <div>
                <label for="observacionesActualizar" class="form-label">Observaciones</label>
                <textarea id="observacionesActualizar" name="observacionesActualizar" rows="3" class="w-full border rounded-md px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
        </div>
    ...
    <!-- Pie del Modal (Acciones) -->
    <div class="mr-4 bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
      <button type="button" id="btnCancelarCompraActualizar" class="btn-neutral px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-base font-medium">
        Cancelar
      </button>
      <button type="button" id="btnActualizarCompraModal" class="btn-success px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition text-base font-medium">
