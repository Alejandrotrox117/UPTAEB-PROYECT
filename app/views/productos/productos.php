    ...
    <div class="min-h-screen mt-4">
        ...
        <div class="bg-white p-6 mt-6 rounded-2xl shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="abrirModalProducto()" class="bg-green-500 text-white px-6 py-2 rounded-lg font-semibold">
                    Registrar
                </button>
            </div>
            ...
            <table id="TablaProductos" class="w-full text-left border-collapse mt-6">
                <thead>
                    <tr class="text-gray-500 text-sm border-b">
                        ...
                        <th class="py-2">Unidad de Medido </th>
...
<!-- Modal -->
<div id="productoModal" class="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-[2px] opacity-0 pointer-events-none transition-opacity duration-300 z-50">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-5xl">
        ...
        <div class="px-8 py-6 border-b flex justify-between items-center">
            ...
            <button onclick="cerrarModalProducto()" class="text-gray-600 hover:text-gray-800 transition-colors">
        ...
        <!-- Formulario -->
        <form id="productoForm" class="px-8 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2  gap-6">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="unidad_medida" name="unidad_medida" class="w-full border rounded-lg px-6 py-4 text-xl focus:outline-none">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="idcategoria" name="idcategoria" class="w-full border rounded-lg px-6 py-4 text-xl focus:outline-none">
            ...
            <div class="flex justify-end space-x-6 mt-6">
                <button type="button" onclick="cerrarModalProducto()" class="px-6 py-3 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition text-xl">
                    Cancelar
                </button>
