...
<!-- Modal -->
<div id="monedaModal" class="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-[2px] opacity-0 pointer-events-none transition-opacity duration-300 z-50">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden w-11/12 max-w-5xl">
        ...
        <form id="monedaForm" class="px-8 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2  gap-6">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="valor" name="valor" rows="3" class="w-full border rounded-lg px-6 py-4 text-xl focus:outline-none"></textarea>
                    </div>
                </div>
            ...
            <div class="flex justify-end space-x-6 mt-6">
                <button type="button" onclick="cerrarModalMoneda()" class="px-6 py-3 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition text-xl">
                    Cancelar
                </button>
