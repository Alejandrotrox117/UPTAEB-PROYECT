document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (e) {
        if (e.target.closest(".editar-btn")) {
            const idpersona = e.target.closest(".editar-btn").getAttribute("data-idpersona");
    ...
    document.addEventListener("click", function (e) {
        if (e.target.closest(".eliminar-btn")) {
            const idpersona = e.target.closest(".eliminar-btn").getAttribute("data-idpersona");
    ...
    function abrirModalPersonaParaEdicion(idpersona) {
        ...
        fetch(`personas/getPersonaById/${idpersona}`)
            ...
            .then((data) => {
                ...
                document.getElementById("telefono_principal").value = persona.telefono_principal || "";
                document.getElementById("correo_electronico").value = persona.correo_electronico || "";
