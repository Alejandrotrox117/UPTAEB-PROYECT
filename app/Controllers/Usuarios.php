...
function usuarios_index() {
    ...
    registrarAccesoModulo('Usuarios', $idusuario);
...
function usuarios_deleteUsuario() {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        try {
            ...
            if ($arrResponse['status'] === true) {
                $resultadoBitacora = registrarEnBitacora('Usuarios', 'ELIMINAR_USUARIO', $idusuario);
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        try {
            ...
            if ($arrData['status']) {
                ...
                registrarEnBitacora('Usuarios', 'EXPORTAR_USUARIOS', $idusuario);
